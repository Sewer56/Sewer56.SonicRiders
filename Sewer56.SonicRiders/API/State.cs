...
namespace Sewer56.SonicRiders.API
{
    ...
    public static unsafe class State
    {
        ...
        /// </summary>
        public static RefFixedArrayPtr<bool> UnlockedStages = new(0x17BE1A4, (int)UnlockedLevels.SEGAIllusion + 1);
        ...
        /// </summary>
        public static RefFixedArrayPtr<bool> UnlockedCharacters = new(0x17BE540, (int)Characters.E10000R + 1);

        /// <summary>
        /// An array of unlocked gears in the game.
        /// Use <see cref="ExtremeGearModel"/> as an indexer.
        /// </summary>
        public static RefFixedArrayPtr<bool> UnlockedGearModels = new(0x017BE4E8, (int)ExtremeGearModel.Cannonball + 1);
        ...
        /// </summary>
        public static RefFixedArrayPtr<byte> GearIdToModelMap = new(0x005BBF5C, (int)Structures.Enums.ExtremeGear.Cannonball + 1);
